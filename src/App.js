...
function App() {
    return (
      <form className="form-inline">
          ...
          <label className="sr-only" for="inlineFormInputGroupUsername2">E-mail</label>
          <div className="input-group mb-2 mr-sm-2">
              <div className="input-group-prepend">
                  <div className="input-group-text">@</div>
              </div>
              <input type="text" className="form-control" id="inlineFormInputGroupUsername2" placeholder="E-mail"/>
          </div>
